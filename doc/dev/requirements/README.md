...
- `canonical-yaml-schema-contract.md`: Normative contract for canonical YAML structure (`metadata` + `virtual_machine`), machine/topology/boot-storage-network intent, firmware/TPM identity, host-resource catalog boundary, and validation semantics.
