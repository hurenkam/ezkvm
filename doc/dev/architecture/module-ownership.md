...
Date: 2026-04-15  
Status: Active  
Related: `doc/dev/architecture/architecture-guidelines.md`, `doc/dev/architecture/decisions/ADR-0001-base-selection.md`
...
| `import/` | Normalize external config formats into canonical schema | Parser adapters, intermediate import models, canonical mapping contracts | Runtime orchestration and direct QEMU invocation | `src/import/mod.rs` (module boundary), `doc/dev/architecture/decisions/ADR-0002-import-normalization-contract.md` |
