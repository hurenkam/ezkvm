...
| FR-003, FR-004, FR-005, FR-006 | [canonical-yaml-validation](../features/done/canonical-yaml-validation.md) | done | squad | [canonical-yaml-schema-contract](../../dev/requirements/canonical-yaml-schema-contract.md), [input/felucia/108.conf](../../../input/felucia/108.conf), `cargo test --quiet` |
| FR-003, FR-004, FR-005, FR-006 | [schema-host-resource-boundary-slice](../backlog/schema-host-resource-boundary-slice.md) | backlog | Apone | [input/felucia/108.conf](../../../input/felucia/108.conf), [input/coruscant/3101.conf](../../../input/coruscant/3101.conf) |
