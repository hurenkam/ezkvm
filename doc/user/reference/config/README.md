...
12. [../../troubleshooting/config.md](../../troubleshooting/config.md) — Common issues and diagnostic checks
...
- **Debugging Issues**: Use [../../troubleshooting/config.md](../../troubleshooting/config.md)
...
| [../../troubleshooting/config.md](../../troubleshooting/config.md) | Memory, display, boot, PCI, USB issues |