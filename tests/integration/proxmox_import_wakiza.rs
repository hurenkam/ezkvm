...
fn test_wakiza_import_preserves_key_proxmox_fragments() {
    ...
    let result = with_repo_profiles(|| {
        run_import_from_files(
            ...
            &ImportRunOptions {
                ...
                runtime_target: ezkvm::import::proxmox::RuntimeTarget::ProxmoxParity,
            },
        )
    ...
    let generated_only_fragments = [
        "type=tap,id=net0,",
        "script=/usr/libexec/qemu-server/pve-bridge,downscript=/usr/libexec/qemu-server/pve-bridgedown,vhost=on",
