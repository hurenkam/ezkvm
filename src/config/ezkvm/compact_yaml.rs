use crate::{
    config::ezkvm::schema::{
        ...
        Metadata, NetworkResourceSchema, PcieDeviceResourceSchema, ResourceSchema,
        ...
        let node = match self {
            ...
            ResourceSchema::PcieDevice { id, pcie } => {
                let pcie_value = match pcie {
                    PcieDeviceResourceSchema::HostAddress {
                        address,
                        multifunction,
                        rombar,
                        romfile,
                    ...
                    PcieDeviceResourceSchema::Address { .. } => {
            ...
            ResourceSchema::PciDevice { .. } | ResourceSchema::UsbDevice { .. } => {
