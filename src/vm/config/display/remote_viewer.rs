use super::super::spice::SpiceSocket;
use super::super::vnc::VncSocket;
...
impl QemuDevice for RemoteViewer {
    fn get_qemu_args(&self, _index: usize) -> Vec<String> {
        vec!["-display egl-headless,gl=on".to_string()]
    }
...
mod tests {
    ...
    fn test_defaults() {
        ...
        let expected: Vec<String> = vec!["-display egl-headless,gl=on".to_string()];
