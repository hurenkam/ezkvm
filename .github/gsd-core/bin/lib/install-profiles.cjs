 ...
 * staged directory (`rewriteStagedSkillBodies`, surface.cts): a `.github/`
 ...
 *   1. applyAgentPathRewrites   (4 base .github/ regexes; skipped for copilot/antigravity)
    ...
    try {
        ...
        for (const entry of entries) {
            ...
            if (agentCtx) {
                ...
                // Step 1: path rewrites (4 base .github/ regexes; skipped for copilot/antigravity)
