...
<!-- For checkpoint task examples and patterns, see @.github/gsd-core/references/checkpoints.md -->
...
See `.github/gsd-core/references/tdd.md` for TDD plan structure.
...
See `.github/gsd-core/templates/user-setup.md` for full schema and examples
...
See `.github/gsd-core/workflows/verify-phase.md` for verification logic.
