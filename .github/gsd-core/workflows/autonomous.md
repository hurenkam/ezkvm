...
Display `Phase ${PHASE_NUM} ✅ ${PHASE_NAME} — Verification passed`, run `@.github/gsd-core/workflows/transition.md`, then Proceed to iterate step.
...
Read and execute: `.github/gsd-core/references/autonomous-smart-discuss.md`
