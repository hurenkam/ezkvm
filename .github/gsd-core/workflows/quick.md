...
- ./copilot-instructions.md or ./.github/copilot-instructions.md (if exists — project-specific guidelines)
...
- ./copilot-instructions.md or ./.github/copilot-instructions.md (if exists — follow project-specific guidelines)
...
- ${STATE_PATH} (Project state)
- ./copilot-instructions.md or ./.github/copilot-instructions.md (Project instructions, if exists)
