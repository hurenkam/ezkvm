...
@.github/gsd-core/references/execute-phase-response-language.md
...
@.github/gsd-core/references/execute-phase-quota-recovery.md
...
**If gaps_found:**
@.github/gsd-core/references/execute-phase-requirement-revert.md
```
