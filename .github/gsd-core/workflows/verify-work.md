...
<template>
@.github/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@.github/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `.github/gsd-core/workflows/transition.md`.
...
- Follow @.github/gsd-core/workflows/diagnose-issues.md
