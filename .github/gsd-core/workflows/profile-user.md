...
Key references:
- @.github/gsd-core/references/ui-brand.md (display patterns)
- @.github/agents/gsd-user-profiler.md (profiler agent definition)
- @.github/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH=".github/gsd-core/USER-PROFILE.md"
...
```bash
cp ".github/gsd-core/USER-PROFILE.md" ".github/USER-PROFILE.backup.md"
```
...
✓ Stores profile at .github/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `.github/gsd-core/references/user-profiling.md`
...
Reference: @.github/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to .github/gsd-core/USER-PROFILE.md"
...
**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at .github/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Your profile:    .github/gsd-core/USER-PROFILE.md
```
...
Artifacts:
  ...
  ✓ copilot-instructions.md section       <resolved claude_md_path, default ./.github/copilot-instructions.md>
  ✓ Global copilot-instructions.md        .github/copilot-instructions.md
```

(Show the `claude_md_path` actually returned by the command — it defaults to `./.github/copilot-instructions.md` but may be overridden by config or `--output`.)
