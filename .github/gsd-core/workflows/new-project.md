...
SPIKE_SKILL=$(ls ./.github/skills/spike-findings-*/SKILL.md 2>/dev/null | head -1 || true)

# Check for sketch findings skill (project-local)
SKETCH_SKILL=$(ls ./.github/skills/sketch-findings-*/SKILL.md 2>/dev/null | head -1 || true)
...
Use template: .github/gsd-core/templates/research-project/STACK.md
</output>
...
Use template: .github/gsd-core/templates/research-project/FEATURES.md
</output>
...
Use template: .github/gsd-core/templates/research-project/ARCHITECTURE.md
</output>
...
Use template: .github/gsd-core/templates/research-project/PITFALLS.md
</output>
...
- `.planning/ROADMAP.md`
- `.planning/STATE.md`
- `$INSTRUCTION_FILE` (runtime-derived via the shared `getProjectInstructionFile` policy: `AGENTS.md` for codex/opencode/kilo/kimi, `.github/copilot-instructions.md` for copilot, `GEMINI.md` for gemini/antigravity, `.github/copilot-instructions.md` for claude)
...
- [ ] `$INSTRUCTION_FILE` generated with GSD workflow guidance (runtime-derived via the shared `getProjectInstructionFile` policy — `AGENTS.md` for codex/opencode/kilo/kimi, `.github/copilot-instructions.md` for copilot, `GEMINI.md` for gemini/antigravity, `.github/copilot-instructions.md` for claude; an existing hand-crafted file without GSD markers is left untouched unless `--force`)
