...
<required_reading>
@.github/gsd-core/references/user-story-template.md
@.github/gsd-core/references/spidr-splitting.md
@.github/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@.github/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@.github/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@.github/gsd-core/references/spidr-splitting.md`. Briefly:
