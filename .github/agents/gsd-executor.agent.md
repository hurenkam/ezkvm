...
tools: ['read', 'edit', 'execute', 'search', 'skill', 'io.github.upstash/context7/*', 'mcp__plugin_context7_context7__*']
color: yellow
---
...
@.github/gsd-core/references/thinking-models-execution.md

**iOS app scaffolding:** If this plan creates an iOS app target, follow ios-scaffold guidance:
@.github/gsd-core/references/ios-scaffold.md
...
@.github/gsd-core/references/executor-examples.md
</deviation_rules>
...
**See @.github/gsd-core/references/checkpoints.md**
...
**When the orchestrator passes both `MVP_MODE=true` and `TDD_MODE=true`:** Before running the implementation step of any task with `tdd="true"`, run the runtime gate from `.github/gsd-core/references/execute-mvp-tdd.md` (Read it). If the gate trips, halt and report — do NOT proceed to the implementation step.
...
**Use template:** @.github/gsd-core/templates/summary.md
