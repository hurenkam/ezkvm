...
description: "Use when reviewing PRs, refactors, or Rust code changes for compliance with doc/dev/workflow/coding-guidelines.md; report violations with actionable fixes."
model: GPT-5.3-Codex
---
...
Primary objective:
- Audit code changes against doc/dev/workflow/coding-guidelines.md.

When invoked:
1. Read doc/dev/workflow/coding-guidelines.md first.
